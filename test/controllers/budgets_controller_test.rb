...
class BudgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget" do
    assert_difference('Budget.count') do
      post budgets_url, params: { budget: { income: @budget.income, user_id: @budget.user_id } }
    end
  ...
  test "should update budget" do
    patch budget_url(@budget), params: { budget: { income: @budget.income, user_id: @budget.user_id } }
